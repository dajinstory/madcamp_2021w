...
public class CameraManagerOriginal : MonoBehaviour {
	...
	public static CameraManagerOriginal singleton; //You can call CameraManager.singleton from other script (There can be only one)
	void Awake()
	{
